...
let DatabaseService = class DatabaseService {
    ...
    connect() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (yield mongodb_1.MongoClient.connect(url, this.configService.config.mongodb.options)).db(databaseName);
        });
    }
    mongooseConnect() {
        return mongoose_1.connect(`${this.configService.config.mongodb.url}/${this.configService.config.mongodb.databaseName}`, this.configService.config.mongodb.options);
    }
};
