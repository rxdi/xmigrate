...
📨  ${chalk_1.default.bold('Message: ' + e.message)}
      `);
            ...
            try {
                yield util_1.promisify(fs_1.rmdir)(path_1.join(process.cwd(), this.configService.config.outDir));
            }
            catch (e) { }
        });
    }
    rollback(fileName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            console.log(`
\n🙏  ${chalk_1.default.bold('Status: Executing rallback operation')} ${chalk_1.default.red('xmigrate down')}
📁  ${chalk_1.default.bold('Migration:')} ${migrationPath}
      `);
            let migration;
            if (this.resolver.isTypescript(fileName)) {
                migration = yield this.resolver.loadTsMigration(fileName);
            }
            else {
            ...
            console.log(`\n🚀  ${chalk_1.default.green('Rallback operation success, nothing changed if written correctly!')}`);
            logger.log(response);
            return response;
        });
    }
