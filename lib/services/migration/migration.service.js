...
const ensure_folder_1 = require("../../helpers/ensure-folder");
...
let MigrationService = class MigrationService {
    ...
    ensureFolders() {
        return __awaiter(this, void 0, void 0, function* () {
            yield ensure_folder_1.ensureDir(this.configService.config.logger.folder);
            yield ensure_folder_1.ensureDir(this.configService.config.migrationsDir);
        });
    }
    up() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const migrateItem = (item) => __awaiter(this, void 0, void 0, function* () {
                ...
                const collection = db.collection(this.configService.config.changelogCollectionName);
                const { fileName } = item;
    ...
    down() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (lastAppliedItem) {
                try {
                    const migration = this.migrationsResolver.loadMigration(lastAppliedItem.fileName);
                    result = yield migration.down(db);
                }
                catch (err) {
                    const error = new error_1.ErrorMap(err.message);
