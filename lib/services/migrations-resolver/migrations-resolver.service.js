...
let MigrationsResolver = class MigrationsResolver {
    constructor(configService) {
        ...
        this.defaultCompilationPath = `${process.cwd()}/dist/`;
    }
    getFileNames() {
    ...
    loadMigration(fileName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.isTypescript(fileName)) {
                migration = yield this.loadTsMigration(fileName);
            }
            else {
    ...
    deleteArtefacts(fileName) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.delete(fileName);
            yield this.delete(`${fileName}.map`);
        });
    }
    delete(fileName) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, rejects) => {
                fs_1.unlink(this.getTsFilePath(fileName), err => {
                    if (err) {
                        rejects(err);
                    }
                    resolve(true);
    ...
    transpileMigrations(migrations) {
        return __awaiter(this, void 0, void 0, function* () {
            yield typescript_builder_1.TranspileTypescript(migrations.map(fileName => this.getRelativePath(fileName)));
        });
    }
    getTsFilePath(fileName) {
        return `${this.defaultCompilationPath}${this.replaceFilenameJsWithTs(fileName)}`;
    }
    ...
    resolve() {
        return __awaiter(this, void 0, void 0, function* () {
            if (path_1.isAbsolute(this.configService.config.migrationsDir)) {
                return this.configService.config.migrationsDir;
            }
            return path_1.join(process.cwd(), this.configService.config.migrationsDir);
        });
    }
};
